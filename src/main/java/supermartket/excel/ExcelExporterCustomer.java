...
public class ExcelExporterCustomer {
    ...
    public static void exportTableToExcel(JTable table, List<Customer> list, String filePath) {
        ...
        for (int row = 0; row < list.size(); row++) {
            ...
            excelRow.createCell(0).setCellValue(list.get(row).getCustomerID());
            excelRow.createCell(1).setCellValue(list.get(row).getFullName());
            excelRow.createCell(2).setCellValue(list.get(row).getPhone());
            excelRow.createCell(3).setCellValue(list.get(row).getEmail());
            excelRow.createCell(3).setCellValue(list.get(row).getEmail());
        }
