 ...
 * @author hanguyen
 */
public class UpdateSupplierJDialog extends javax.swing.JDialog {
    SupplierDAO dao = new SupplierDAOImpl();
    /**
     * Creates new form CreateSupplier
     */
    public UpdateSupplierJDialog(java.awt.Frame parent, boolean modal, Supplier sup) {
        super(parent, modal);
        initComponents();
        txtSupplierId.setText(sup.getSupplierID());
        txtName.setText(sup.getSupplierName());
        txtAddress.setText(sup.getAddress());
        txtEmail.setText(sup.getEmail());
        txtPhone.setText(sup.getPhone());
        cboStatus.setSelectedItem(sup.getStatus() ? "Đang hợp tác" : "Ngừng hợp tác");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                UpdateSupplierJDialog dialog = new UpdateSupplierJDialog(new javax.swing.JFrame(), true, sup);
